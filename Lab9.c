        ...
        if (goingUp) {
            for(i = bottom; i < top; i++) {
				...
				shouldSwap = strcmp(library[i].artist, library[i+1].artist) > 0 || 
							(strcmp(library[i].artist, library[i+1].artist) == 0 && strcmp(library[i].songName, library[i+1].songName) > 0);
            ...
            for (i = top; i > bottom; i--) {
              ...
              //
				shouldSwap = strcmp(library[i-1].artist, library[i].artist) > 0 || 
							(strcmp(library[i-1].artist, library[i].artist) == 0 && strcmp(library[i-1].songName, library[i].songName) > 0);
